    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">Jalan Tanah Abang No.1 Telp/Fax : 021-3441417 Email : kominfotikjp@jakarta.go.id</span>';
            ...
            <div id="lead">
                ...
                <p>Komunikasi, Informatika, dan Statistik</p>
                ...
                if(!empty($kepsek)){
                    ...
                    echo '<p class="lead">Tatik Mulyani</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP. '.$nip.'</p>';
                } else {
